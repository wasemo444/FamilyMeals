...

{
    ...
    private static bool CanMutateEntity(MealCategoryEntity entity, Guid userId, IReadOnlySet<Guid> memberGroupIds) =>

        OwnershipRules.CanMutate(entity.OwnerType, entity.OwnerUserId, entity.OwnerGroupId, userId, memberGroupIds);



    private static bool CanMutateEntity(MealLinkEntity entity, Guid userId, IReadOnlySet<Guid> memberGroupIds) =>

        OwnershipRules.CanMutate(entity.OwnerType, entity.OwnerUserId, entity.OwnerGroupId, userId, memberGroupIds);



    private static void ApplyOwnership(MealCategoryEntity entity, MealCategory model, Guid userId)
    ...
    private static void ApplyOwnership(MealLinkEntity entity, MealCategory category, Guid userId)
