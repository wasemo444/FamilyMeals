...
public partial class Category : IDisposable
{
    ...
    private ContentCategory? _category;
    private string _pageTitle = "LinkNest";
    private string? _error;
    private bool _isAdding;
    private bool _previewsBackfillStarted;
    private string _searchTerm = string.Empty;
    private IReadOnlyList<SavedLink> _favoriteLinks = [];
    private IReadOnlyList<SavedLink> _allLinks = [];
