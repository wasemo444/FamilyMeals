...
/// <summary>
/// Browser local-storage implementation of <see cref="LinkNest.Shared.Services.IAppDataStore"/>.
/// </summary>
/// <remarks>
/// Legacy/unused: the app now persists data through the API-backed <see cref="LinkNest.Shared.Services.ApiContentDataService"/>.
/// Retained for reference; not registered in dependency injection.
/// </remarks>
public sealed class LocalStorageAppDataStore(IJSRuntime jsRuntime) : LinkNest.Shared.Services.IAppDataStore
{
