...
/// </remarks>
public sealed class ContentDataLoadMiddleware(RequestDelegate next)
{
    ...
    public async Task InvokeAsync(HttpContext context, IContentDataService mealDataService)
    {
