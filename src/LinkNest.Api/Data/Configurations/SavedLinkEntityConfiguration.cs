...
/// <summary>
/// EF Core fluent configuration for <see cref="SavedLinkEntity"/> including ownership check constraint and concurrency token.
/// </summary>
public sealed class SavedLinkEntityConfiguration : IEntityTypeConfiguration<SavedLinkEntity>
{
    public void Configure(EntityTypeBuilder<SavedLinkEntity> builder)
    {
