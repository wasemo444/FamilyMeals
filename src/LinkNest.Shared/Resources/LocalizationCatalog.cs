...
public static class LocalizationCatalog
{
    private static readonly Dictionary<string, Dictionary<string, string>> Strings = new(StringComparer.OrdinalIgnoreCase)
    {
        ["en"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ConfirmEmailInProgress"] = "Confirming your email address…",
            ["PasswordsDoNotMatch"] = "Passwords do not match.",
            ["LoginFailed"] = "Login failed. Please try again.",
            ["PleaseWait"] = "Please wait…",
            ["RegisterFailed"] = "Registration failed. Please try again.",
            ["RegisterTimeout"] = "The request timed out. The server may be waking up or email delivery is slow — wait a minute and try again.",
            ["RegisterNetworkError"] = "Could not reach the server. Check your connection and try again.",
        ...
        ["ar"] = new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ConfirmEmailInProgress"] = "جارٍ تأكيد بريدك الإلكتروني…",
            ["PasswordsDoNotMatch"] = "كلمتا المرور غير متطابقتين.",
            ["LoginFailed"] = "فشل تسجيل الدخول. حاول مرة أخرى.",
            ["PleaseWait"] = "يرجى الانتظار…",
            ["RegisterFailed"] = "فشل إنشاء الحساب. حاول مرة أخرى.",
            ["RegisterTimeout"] = "انتهت مهلة الطلب. قد يكون الخادم يستيقظ أو أن إرسال البريد بطيء — انتظر دقيقة وحاول مرة أخرى.",
            ["RegisterNetworkError"] = "تعذّر الاتصال بالخادم. تحقق من اتصالك وحاول مرة أخرى.",
