...
/// </summary>
public static class ContentDataQueries
{
    /// <summary>
    ...
    public static IReadOnlyList<ContentCategory> GetFavoriteCategories(AppData data, HomeContentFilter filter = HomeContentFilter.All) =>
    ...
    /// <param name="data">Data snapshot to query.</param>
    /// <param name="filter">Personal, shared, or all categories.</param>
    public static IReadOnlyList<ContentCategory> GetActiveCategories(AppData data, HomeContentFilter filter = HomeContentFilter.All) =>
    ...
    /// </summary>
    /// <param name="data">Data snapshot to query.</param>
    public static IReadOnlyList<ContentCategory> GetArchivedCategories(AppData data) =>
        data.Categories
    ...
    public static ContentCategory? GetCategory(AppData data, Guid categoryId) =>
    ...
    public static IReadOnlyList<SavedLink> GetFavoriteLinks(AppData data, Guid categoryId) =>
    ...
    /// <param name="data">Data snapshot to query.</param>
    /// <param name="categoryId">Parent category id.</param>
    public static IReadOnlyList<SavedLink> GetActiveLinks(AppData data, Guid categoryId) =>
    ...
    /// <param name="data">Data snapshot to query.</param>
    /// <param name="categoryId">Parent category id.</param>
    public static IReadOnlyList<SavedLink> GetArchivedLinks(AppData data, Guid categoryId) =>
        data.Links
    ...
    /// <param name="data">Data snapshot to query.</param>
    public static IReadOnlyList<SavedLink> GetAllArchivedLinks(AppData data) =>
        data.Links
    ...
    public static SavedLink? GetLink(AppData data, Guid linkId) =>
    ...
    public static IReadOnlyList<ContentCategory> SortCategories(IEnumerable<ContentCategory> categories) =>
        categories
    ...
    public static IReadOnlyList<SavedLink> SortLinks(IEnumerable<SavedLink> links) =>
        links
            .OrderByDescending(link => link.IsFavorite)
            .ThenByDescending(link => link.CreatedAtUtc)
            .ToList();

    private static IEnumerable<ContentCategory> FilterCategories(IEnumerable<ContentCategory> categories, HomeContentFilter filter) =>
