...
public interface IOwnershipAuthorization
{
    ...
    Task EnsureCanMutateCategoryAsync(ContentCategory category, CancellationToken cancellationToken = default);
    ...
    Task EnsureCanMutateLinkAsync(SavedLink link, CancellationToken cancellationToken = default);
}
