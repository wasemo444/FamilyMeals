...
{
    [Fact]
    public void ContentCategoryEntity_ToModel_MapsAllFields()
    {
        // Arrange
        var entity = new ContentCategoryEntity
        {
            Id = Guid.NewGuid(),
            Name = "Breakfast",
            IsFavorite = true,
    ...
    [Fact]
    public void SavedLink_RoundTripMapping_PreservesAllFields()
    {
        // Arrange
        var original = new SavedLink
        {
            Id = Guid.NewGuid(),
